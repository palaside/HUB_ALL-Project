  ...
  return (
    <>
      <div className="flex items-center space-x-2 mb-2 shrink-0">
        <ShieldAlert className="text-hazard-orange" size={20} />
      ...
      <div className="flex space-x-2 mb-4 shrink-0">
        <button className="flex-1 bg-crimson-red/20 text-crimson-red border border-crimson-red border-b-2 text-xs font-bold py-2 rounded uppercase tracking-wider transition-colors">
          Emergency
        </button>
        <button className="flex-1 bg-gray-800 text-gray-400 border border-gray-700 hover:bg-gray-700 text-xs font-bold py-2 rounded uppercase tracking-wider transition-colors">
          Alerts
        </button>
        <button className="flex-1 bg-gray-800 text-gray-400 border border-gray-700 hover:bg-gray-700 text-xs font-bold py-2 rounded uppercase tracking-wider transition-colors">
          Transport
      ...
      <div className="bg-hub-panel border border-crimson-red/50 rounded-xl p-4 shadow-[0_0_15px_rgba(220,20,60,0.1)] relative overflow-hidden group mb-4">
        <div className="flex items-start justify-between mb-3">
          <div className="flex space-x-3">
            <div className="bg-crimson-red/20 p-2 rounded-lg shrink-0">
              <Car size={20} className="text-crimson-red" />
            </div>
            <div>
              <h3 className="text-white font-bold text-sm">Roadworks Obstruction</h3>
              <p className="text-gray-400 text-xs mt-1">Shinjuku-dori Ave. • 2 Lanes Blocked</p>
            </div>
          </div>
          <span className="text-xs text-crimson-red font-mono font-bold">12:04 PM</span>
        </div>
        ...
        <div className="flex space-x-2 mt-auto">
          <button className="flex-1 bg-crimson-red hover:bg-red-600 text-white font-bold py-2 px-3 rounded text-xs flex items-center justify-center space-x-1 transition-all hover:shadow-[0_0_10px_rgba(220,20,60,0.5)]">
            <Zap size={14} />
            <span>OPTIMIZE</span>
          </button>
          <button className="flex-1 bg-gray-800 hover:bg-gray-700 border border-gray-600 text-gray-200 font-bold py-2 px-3 rounded text-xs flex items-center justify-center space-x-1 transition-colors">
            <Map size={14} />
         ...
         <div className="flex items-start justify-between mb-3">
          <div className="flex space-x-3">
            <div className="bg-hazard-orange/20 p-2 rounded-lg shrink-0">
              <AlertTriangle size={20} className="text-hazard-orange" />
            </div>
            <div>
      ...
      <div className="bg-hub-panel border border-gray-800 rounded-xl p-5 shadow-lg flex-1 flex flex-col group hover:border-gray-600 transition-colors">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-sm font-semibold text-gray-400 uppercase tracking-wider">7-Day Response</h3>
        ...
        <div className="flex justify-between mt-2 text-gray-500 text-[10px] font-mono">
          <span>T-7</span>
          <span>T-3</span>
          <span>TODAY</span>
        </div>
