  ...
  return (
    <>
      ...
      <div className="bg-black border border-gray-800 rounded-xl shadow-lg flex-1 relative overflow-hidden group hover:border-gray-600 transition-colors">
        ...
        <div className="absolute inset-0 sci-fi-grid opacity-30 transform perspective-[1000px] rotateX-[60deg] scale-150 origin-bottom" style={{ transformStyle: 'preserve-3d', transform: 'perspective(500px) rotateX(60deg) scale(2) translateY(-20%)' }} aria-hidden="true"></div>
        
        {/* Glowing Nodes / Map Overlay */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-transparent via-black/60 to-black pointer-events-none" aria-hidden="true"></div>

        {/* Incident Pin */}
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
          <div className="relative">
            <div className="absolute inset-0 bg-crimson-red rounded-full animate-ping opacity-75" aria-hidden="true"></div>
